...
const en = {
  ...
  "admin.editor.write": "Write",
  "admin.editor.previewTab": "Preview",
  "admin.editor.moveUp": "Move image earlier",
  "admin.editor.moveDown": "Move image later",
  "admin.editor.removePhoto": "Remove image from the article",
  ...
  "admin.editor.insertPoll": "Poll",
  "admin.editor.insertQuiz": "Quiz",
  "admin.editor.moveEarlier": "Move earlier",
  "admin.editor.moveLater": "Move later",
  "admin.editor.removeObject": "Remove from the article",
  "admin.editor.copyMarkdown": "Copy markdown",
  "admin.editor.copied": "Copied",
  "admin.editor.pollLabel": "Poll",
  "admin.editor.quizLabel": "Quiz",
  "admin.editor.emptyProse": "Write…",
...
const de: Dict = {
  ...
  "admin.editor.write": "Schreiben",
  "admin.editor.previewTab": "Vorschau",
  "admin.editor.moveUp": "Bild nach vorn",
  "admin.editor.moveDown": "Bild nach hinten",
  "admin.editor.removePhoto": "Bild aus dem Artikel entfernen",
  ...
  "admin.editor.insertPoll": "Umfrage",
  "admin.editor.insertQuiz": "Quiz",
  "admin.editor.moveEarlier": "Nach vorn",
  "admin.editor.moveLater": "Nach hinten",
  "admin.editor.removeObject": "Aus dem Artikel entfernen",
  "admin.editor.copyMarkdown": "Markdown kopieren",
  "admin.editor.copied": "Kopiert",
  "admin.editor.pollLabel": "Umfrage",
  "admin.editor.quizLabel": "Quiz",
  "admin.editor.emptyProse": "Schreiben…",

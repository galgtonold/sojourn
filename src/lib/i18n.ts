...
const en = {
  ...
  "journey.stops": "{n} stops",
  "journey.wholeTrip": "The whole trip",
  ...
  "admin.posts.untitled": "Untitled",
  "admin.posts.createdOn": "created",
  ...
  "admin.updates.recipeDockerNote":
    "If your files are not named docker-compose.yml and .env — older all-in-one installs used docker-compose.all-in-one.yml and .env.selfhost — name them with -f and --env-file. And when the release notes say the compose file itself changed, download it again and add --force-recreate: Compose does not notice when the contents of an inline config change, so it would otherwise keep the old one and report that everything is up to date.",
  ...
  "admin.proofread.field.caption": "Caption",
  "admin.proofread.field.alt": "Alt text",
  "admin.proofread.field.question": "Question",
  "admin.proofread.field.option": "Answer",
  "admin.proofread.field.explanation": "Explanation",
...
const de: Dict = {
  ...
  "journey.stops": "{n} Stationen",
  "journey.wholeTrip": "Die ganze Reise",
  "journey.overview": "Überblick",
  "journey.prev": "Zurück",
  "journey.next": "Weiter",
  ...
  "admin.posts.untitled": "Ohne Titel",
  "admin.posts.createdOn": "angelegt",
  ...
  "admin.updates.recipeDockerNote":
    "Heißen deine Dateien nicht docker-compose.yml und .env — ältere All-in-one-Installationen nutzten docker-compose.all-in-one.yml und .env.selfhost —, benenne sie mit -f und --env-file. Und steht in den Release-Notes, dass sich die Compose-Datei selbst geändert hat, lade sie neu herunter und ergänze --force-recreate: Compose merkt nicht, wenn sich der Inhalt eines eingebetteten Configs ändert, und würde sonst den alten behalten und melden, es sei alles aktuell.",
  ...
  "admin.proofread.field.caption": "Bildunterschrift",
  "admin.proofread.field.alt": "Alt-Text",
  "admin.proofread.field.question": "Frage",
  "admin.proofread.field.option": "Antwort",
  "admin.proofread.field.explanation": "Erklärung",
